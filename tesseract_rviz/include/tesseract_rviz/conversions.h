...
static inline void toEigenLegacy(Eigen::Isometry3d& transform,
...
static inline void toOgreLegacy(Ogre::Vector3& position, Ogre::Quaternion& orientation, const Eigen::Isometry3d& transform)
{
